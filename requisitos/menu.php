...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">LxSoft</a>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="eliminarUsuariosGeneral.php">Eliminar Usuarios</a></li>
            <li><a class="dropdown-item" href="eliminarUsuariosEspecificos.php">Eliminar Usuario Específico</a></li>
