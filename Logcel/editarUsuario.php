...
<?php 
  ...
  include_once "db.php";
  $con=conn();
  $sql="SELECT * FROM `Logcel_usuarios` WHERE `us_Id`=".$_REQUEST['id'];
        ...
        <form action="eddit_user.php" method="POST"  class="fContaimer">
                ...
                <div class="col">
                    ...
                    <label>Daños hadwar:</label>
                        <select name="Hadnuevo"  id="dahad" value="<?php  echo $rowTotal['us_Dañoshad']?>">
                    ...
                    <label>Daños sofware:</label>
                        <select name="Sofnuevo" id="dasof" value="<?php echo $rowTotal['us_Dañossof']?>" >
